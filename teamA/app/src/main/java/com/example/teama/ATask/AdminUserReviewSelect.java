...
public class AdminUserReviewSelect extends AsyncTask<Void, Void, Void> {
    ...
    public AdminUserReviewSelect(ArrayList<UserReviewDTO> userReviewList, AdminUserReviewListAdapter adapter, ProgressDialog progressDialog, String users_nick) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            builder.addTextBody("user_nick", users_nick, ContentType.create("Multipart/related", "UTF-8"));//현재로그인중인 회원 닉네임정보
    ...
    public UserReviewDTO readMessage(JsonReader reader) throws IOException {
        ...
        while (reader.hasNext()) {
            ...
            } else if (readStr.equals("review_no")) {
                review_no = reader.nextInt();
            } else {
                reader.skipValue();
            }
        }
